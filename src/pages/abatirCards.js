...
import { fotosHerrajesAbatir } from '../common/hooks/fotos';
...
const AbatirCards = ()=> {
  ...
  return (
    <div className={classes.root}>
      <Barra categoria="ACCESORIOS VIDRIO TEMPLADO" grupo="HERRAJES DE ABATIR"/>
      <Grid container spacing={2}>
        <Grid item xs={12}>
          <Grid container justify="center" spacing={2}>
            {fotosHerrajesAbatir.map((value) => (
